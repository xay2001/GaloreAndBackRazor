...
def evaluate_model(model, preprocess_batched, pad_idx, global_rank, world_size, device, batch_size):
    ...
    # 验证文件导入修改 1
    val_data = datasets.load_dataset("allenai/c4/en", "default", split="validation", streaming=True) #DGX
...
def main(args):
    ...
    # 训练数据加载修改 2
    data = datasets.load_dataset("allenai/c4", "default", split="train", streaming=True)
